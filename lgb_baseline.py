...
train_feature_path = os.path.join(DATA_ROOT, 'train', 'mengxi_boundary_anon_filtered.csv')
train_label_path   = os.path.join(DATA_ROOT, 'train', 'mengxi_node_price_selected.csv')
test_feature_path  = os.path.join(DATA_ROOT, 'test',  'test_in_feature_ori.csv')

OUTPUT_ROOT = r'd:\others\Southern_Electricity\outputs'
os.makedirs(os.path.join(OUTPUT_ROOT, 'output_price'), exist_ok=True)
os.makedirs(os.path.join(OUTPUT_ROOT, 'output_power'), exist_ok=True)
output_price_path = os.path.join(OUTPUT_ROOT, 'output_price', 'lgb_baseline_output.csv')
output_power_path = os.path.join(OUTPUT_ROOT, 'output_power', 'lgb_baseline_output.csv')
